...
public class MonthSumBuilder implements SummaryBuilder {
    ...
    public MonthSumBuilder(List<Transaction> transactions){
        this.transactionsGranular= transactions;
        this.reset();
    }

    public void reset(){
        this.summaries = new ArrayList<MonthlySummary>();
    }
    ...
    public void calcSums(){
        ...
        foodMonthlySums.forEach((key, value) -> summaries.add(new MonthlySummary(key, value)));


    }

    public List<MonthlySummary> getSummaries(){
        List<MonthlySummary> finalSummaries = this.summaries;
        this.reset();
